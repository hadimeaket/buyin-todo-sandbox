...
const chats = JSON.parse(fs.readFileSync('evaluation/chat_task_attempts.json', 'utf8'));
const code = JSON.parse(fs.readFileSync('evaluation/deep_code_analysis.json', 'utf8'));
...
Object.keys(chats).forEach(branch => {
    ...
    if (d.t1_persistence && d.t1_persistence !== 'memory/other') summary.t1.implemented++;
