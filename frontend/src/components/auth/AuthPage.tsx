...
export const AuthPage: React.FC = () => {
  ...
  const handleGoogleSignIn = () => {
    setLocalError('Google Sign-In requires configuration. Please set up your Google OAuth credentials.');
  };

  const handleAppleSignIn = () => {
    setLocalError('Apple Sign-In requires configuration. Please set up your Apple OAuth credentials.');
  };
          ...
          <div className="auth-social">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 18 18">
                ...
                <path fill="#FBBC05" d="M3.964 10.706c-.18-.54-.282-1.117-.282-1.706 0-.593.102-1.17.282-1.709V4.959H.957C.347 6.173 0 7.548 0 9s.348 2.827.957 4.041l3.007-2.335z"/>
