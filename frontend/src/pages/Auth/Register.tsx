  ...
  const handleAppleSignup = async () => {
    ...
    try {
      if (window.AppleID) {
        ...
        await loginWithApple(data.authorization.code, data.user);
        navigate("/");
      } else {
    ...
    <div className="auth-container">
      <div className="auth-card">
        ...
        <div className="sso-buttons">
          <button onClick={handleGoogleSignup} className="sso-button google">
          ...
          <button onClick={handleAppleSignup} className="sso-button apple">
            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path
                fill="#000000"
