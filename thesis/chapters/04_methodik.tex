...
\begin{itemize}
    ...
    \item  \textbf{Mitigation:} Kompetenz wird als Analyseperspektive über eine auditierbare, diskrete Pre-Survey-Heuristik operationalisiert (Tabelle~\ref{tab:competence-rubric}). Es wird explizit keine psychometrische Validierung beansprucht; die Einordnung wird über Triangulation mit Artefaktspuren (Pipeline/Code/Test/Chat) abgesichert. Da die Kompetenzzuordnung auf Selbstauskunft im Pre-Survey beruht, sind systematische Verzerrungen (z.\,B. Selbstüberschätzung/soziale Erwünschtheit und unterschiedliche Interpretation von Skalen) möglich, sodass die Kompetenzgruppen als Analyseperspektiven und nicht als objektives Kompetenzmaß zu verstehen sind.
\end{itemize}
