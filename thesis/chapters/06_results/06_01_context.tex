...
\begin{enumerate}
    ...
    \begin{itemize}
        \item Pfad: Remote-Branches mit dem Suffix \texttt{*-vibe} (z.B. \texttt{origin/nachname-vorname-vibe}).
    \end{itemize}
...
\begin{table}[h]
    ...
    \hline
    Git-Branches (\texttt{*-vibe}) & 18 & Vollständig als Remote-Branches vorhanden \\
...
\begin{itemize}
    ...
    \item \textbf{Chat $\leftrightarrow$ Branch:} Die Dateinamen der Chat-Logs (z.B. \texttt{Nachname\_Vorname.docx}) wurden normalisiert und den entsprechenden Branches (z.B. \texttt{nachname-vorname-vibe}) zugeordnet.
\end{itemize}
